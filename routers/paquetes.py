...
@paquetes_router.get('/paquetes', tags=['Paquetes'], response_model=List[Paquetes],
...
@paquetes_router.get('/paquetes/{id}', tags=['Paquetes'], response_model=Paquetes, dependencies=[Depends(JWTBearer())])
